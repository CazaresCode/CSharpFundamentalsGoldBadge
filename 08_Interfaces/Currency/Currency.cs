...
namespace _08_Interfaces.Currency
{
    ...
    public class ElectronicPayment : ICurrency
    {
        ...
        //Without a set or private set on value, we can only set value when making the object in a constuctor.
        ...
        public decimal Value { get; } //add the property later, aka line 34 (public ElectronicPayment(decimal value)...
    }
}
